...
var ReactMapboxGl = (_temp2 = _class = function (_React$PureComponent) {
  _inherits(ReactMapboxGl, _React$PureComponent);
  ...
  function ReactMapboxGl() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args))), _this), _this.div = document.createElement('div'), _temp), _possibleConstructorReturn(_this, _ret);
  }
